...
void initEntityNames() {
	...
	entityNames[3] = { u8"¿ÕÍ¶¹·ÔÓ", colors.ShiShi };
	...
	entityNames[42] = { u8"´óµçÄÔ", colors.ShengQi };
	entityNames[43] = { u8"×¢ÉäÆ÷", colors.ShengQi };
	entityNames[44] = { u8"´óµç³Ø", colors.ShengQi };
	entityNames[45] = { u8"Ð¡µç³Ø", colors.ShengQi };

	entityNames[46] = { u8"Ò»¼¶Í·", colors.PuTong };
	entityNames[47] = { u8"¶þ¼¶Í·", colors.GaoJi };
	entityNames[48] = { u8"Èý¼¶Í·", colors.ShengQi };
	entityNames[49] = { u8"ËÄ¼¶Í·", colors.ShiShi };

	entityNames[50] = { u8"Ò»¼¶¼×", colors.PuTong };
	entityNames[51] = { u8"¶þ¼¶¼×", colors.GaoJi };
	entityNames[52] = { u8"Èý¼¶¼×", colors.ShengQi };
	entityNames[53] = { u8"ËÄ¼¶¼×", colors.ShiShi };

	entityNames[54] = { u8"Ò»¼¶¶Ü", colors.PuTong };
	entityNames[55] = { u8"¶þ¼¶¶Ü", colors.GaoJi };
	entityNames[56] = { u8"Èý¼¶¶Ü", colors.ShengQi };
	entityNames[57] = { u8"ËÄ¼¶¶Ü", colors.ShiShi };

	entityNames[58] = { u8"Ò»¼¶°ü", colors.PuTong };
	entityNames[59] = { u8"¶þ¼¶°ü", colors.GaoJi };
	entityNames[60] = { u8"Èý¼¶°ü", colors.ShengQi };
	entityNames[61] = { u8"ËÄ¼¶°ü", colors.ShiShi };
	...
	entityNames[101] = { u8"¸ÉÈÅÕßµ¯Ò©", colors.ShiShi };
	entityNames[102] = { u8"´¸µãµ¯Ò©", colors.ShiShi };
...
void initBones() {
	...
	//»ÃÏó
	{
		...
		»ÃÏó[1][7] = Bones::»ÃÏó×ó¼ç - 2;

		»ÃÏó[1][8] = Bones::»ÃÏóÓÒ¼ç - 2;
